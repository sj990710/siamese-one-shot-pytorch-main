...
#     train_dataset = dset.ImageFolder(train_dir)
    ...
    #
    # print("Returned sample data:", sample_data)
    # print("Data type of the first element:", type(sample_data[0]))
    # print("Size of the first element:", sample_data[0].size())
    # print("Data type of the second element:", type(sample_data[1]))
    # print("Size of the second element:", sample_data[1].size())
    # print("Data type of the label:", type(sample_data[2]))
